				...
				<tr>
					...
					<td id="ddL">
						<div  id="cont" >
							...
							<ul>
								<li >   
									<a href="medical.php"><img style="margin-top:0px;margin-left: -5px;" src="../Model/Logo/mediLgo.png"></a>      
									<ul>
		...
		<div>
			<tr>
				...
				<select onchange="location=this.value" style="font-size:20px;border-radius: 15px;height: 45px;width:100%;border:1px solid black; text-align: center;">
					...
					<option >Select your problem type</option>
					<option value="general.php">General(all type of problems)</option>
					<option value="cardiac.php">Cardiac(chest pain)</option>
					<option value="ortho.php">Orthpaidics(injuries & fractures)</option>
					<option value="Gyneco.php">Gyne(female problems)</option>
					<option value="neuro.php">Neuro(Headache & brain problems)</option>
				</select>
				</td>
			</tr>
...
<!-- ///////////////////////////////// photo slide start ////////////////////////////////-->
		...
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
			  ...
			  <img src="../Model/images/cardi.jpg" style="width:100%">
			  <div class="text"></div>
			</div>

			<div class="mySlides fade">
			  <div class="numbertext">2 / 3</div>
			  <img src="../Model/images/neuro.jpg" style="width:100%">
			  <div class="text"></div>
			</div>

			<div class="mySlides fade">
			  <div class="numbertext">3 / 3</div>
			  <img src="../Model/images/Neuro2ed.jpg" style="width:100%">
			  <div class="text"></div>
			</div>
...
///////////////////////////////////////////////-->
	...
	<div class="body" >
		...
		<table>
			...
			$query="SELECT * FROM dept WHERE type='medi' ";
			...
			if ($run) {
				while ($data=mysqli_fetch_assoc($run)) {
					...
					<tr id="t1">
						...
						<td style=" background-image: url(<?php echo "../Model/images/".$data['pic'];?>); height: 450px;width: 990px">
					
							<a href="<?php echo $data['link'];?>" target="_blank">
								<span style="color:black;font-size: 50px;opacity: .7; text-decoration: none;">
									<?php echo $data['name'];?>
								</span>
							</a>

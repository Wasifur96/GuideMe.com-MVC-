...
<body>
	...
	<div class="body" >
		...
		<div style="height: 400px;background-image: url(inanil.jpg);">
			

		</div>
		<div style="text-align: left;font-size: 30px;">
			<br><b>Location:</b>  Ukhia Thana, Cox's bazar, Bangladesh<br><br>
			<p >
			Inani Beach (also Enani Beach) is an 18-kilometre-long (11 mi) sea beach in Ukhia Upazila of Cox's Bazar District, Bangladesh. It has a lot of coral stones, which are very sharp. These coral stones look black and green, and they are found in summer or rainy seasons. 
	...
	<div id="comment_box">
		...
		<?php
			...
			$query="SELECT * FROM comment WHERE name='inani'";
	...
	<div >
		...
		method="post">
			...
			<input type="submit" name="comment_inani" value="Post">
			<br>
			<a href="hotelcox.php">
					<div class="hb" >
						Hotels around

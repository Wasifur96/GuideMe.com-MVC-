...
<div class="mySlides fade">
  ...
  <img src="../Model/images/Medi_study.jpg" style="width:100%" height="500px">
  <div class="centered">
		<span style="color:black;font-size: 60px;opacity: .7; text-decoration: none;" >
				Medical specialized institudes 
		</span>
  </div>
...
function closeSlideMenu()
	...
	<div class="body" >
		...
		<table>
			...
			$query="SELECT * FROM edu WHERE dept='medi_study'";

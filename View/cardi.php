...
<!--///////////////////////////////////////////////// Log In //////////////////////////////////////////////////////// -->		
		...
		<div style="text-align: right;background-color: #4f87e2;height: 55px;">
			...
			if(isset($_SESSION['uid']))
			{
				...
				echo 	"<tr>";
				echo 		"<td>";
				echo 			"<a href='logout.php'><button type='button' onclick='".session_destroy()."'>Log Out</button></a>";
				echo 		"</td>";
				echo 	"</tr>";
				echo "</table>";
    			...
    			echo		"<a href='medi_story.php'>My Treatment Story</a>";   			
  				echo	  "</div >";
			}
			else
			{
				...
				echo	"<tr>";
				echo		"<td>";
				echo			"<input type='text' name='val_name' placeholder='username'>";
				echo		"</td>";
				echo		"<td>";
...
<div class="mySlides fade">
  ...
  <img src="cardi.jpg" style="width:100%" height="500px">

  <div class="centered">
		<span style="color:black;font-size: 60px;opacity: .7; text-decoration: none;" >
				Cardiac Specialized Hospitals
		</span>
  </div>

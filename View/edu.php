...
<!-- ///////////////////////////////// photo slide start ////////////////////////////////-->
		...
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
			  ...
			  <img src="../Model/images/sc1.jpg" style="width:100%">
			  <div class="text"></div>
			</div>

			<div class="mySlides fade">
			  <div class="numbertext">2 / 3</div>
			  <img src="../Model/images/Neuro2.jpg" style="width:100%">
			  <div class="text"></div>
			</div>

			<div class="mySlides fade">
			  <div class="numbertext">3 / 3</div>
			  <img src="../Model/images/bba.jpg" style="width:100%">
			  <div class="text"></div>
			</div>
...
///////////////////////////////////////////////-->
	...
	<div class="body" >
		...
		<table>
			...
			$query="SELECT * FROM dept WHERE type='edu' ";
